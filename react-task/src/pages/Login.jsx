...
const Login = () => {
  ...
  return (
    <FormContainer>
      <h1 className='text-center text-2xl text-gray-700 font-bold'>User Login</h1>
      ...
      <Row className='py-3'>
        <Col>
          Don't have an account? <Link className='text-blue-500 text-base font-bold' to='/register'>Register</Link>
        </Col>
      </Row>
    </FormContainer>
  );
